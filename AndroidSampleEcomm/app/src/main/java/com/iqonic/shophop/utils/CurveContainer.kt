...
import developer.shivam.crescento.PathProvider


class CurveContainer : RelativeLayout {

    internal lateinit var mContext: Context

    internal lateinit var mClipPath: Path
    internal lateinit var mOutlinePath: Path

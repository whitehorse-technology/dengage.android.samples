...
public class Constants {
    ...
    // Test (Android Huawei)
    public static String HUAWEI_INTEGRATION_KEY = "j1sJXoAI_p_l_6Nl3Lfv15np23V3PdaR1obsEauM1sRO2obF5apGWwVKl2eLYYvycapWEAIGEX3aRRzMBQALomcLCE5jyFHv6Q7J3Fp_p_l_JzI7Kozunho9C08fj3E1zbAvRJYE";

    // Preprod (Android Firebase)
    //public static String FIREBASE_INTEGRATION_KEY = "Y1ArFo9UOii9KWRncAB0yFTTBCqFfsgPuEcASGp_p_l_KT6qhzw76vuomCcZ16OY0wkSl45_s_l_28PVaGLXlm2lx49zc2zvULFKEreMF0BqBpk_p_l_8uOCSpN8T_s_l_RFppygNKUIdctQ";

    // Preprod (Android Huawei)
    ...
    // Prod Ecomm (Android Firebase)
    //public static String FIREBASE_INTEGRATION_KEY = "KwUCoREMgcAKAoqEo_p_l_RBChQuYoNGJgR1C6roPB3_p_l__p_l_JzzTVLUbQ4KQfh58tAf4bCZ_p_l_NauNCwcl68CRLDFTpz32kGHtVOvFwcnV5QIYRdp8rH5fnExRj_p_l_s5ElERm763qxd";
